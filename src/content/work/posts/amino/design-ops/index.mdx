...
<div className="stack__children--4" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
...
<Image name="component-documentation-page" caption="This entire page is generated automatically from content in the Amino dependency. To keep the documentation site up-to-date, the site simply needs to be re-built with the newest version of Amino." />
