...
<Gallery caption="Two different tables in the same Strateos app, each with similar functionality, implemented in different ways.">
  <Image imgs={props.images} name="inventory-table" hasShadow />
  <Image imgs={props.images} name="location-table" hasShadow />
</Gallery>
...
<Gallery caption="Viewing an experiment as a customer and employee. There are some shared elements, but the two views have different layouts, hierarchy and interactions.">
  <Image imgs={props.images} name="user-run" />
  <Image imgs={props.images} name="admin-run" />
</Gallery>
...
<Image imgs={props.images} name="spacing-task" caption="An example of one of the dozens of UI bug tickets that would get filed with our engineering team." />
...
<Image imgs={props.images} name="typography" caption="Our codebase had new and legacy typography systems demonstrating how unnecessarily opaque and complex our styling code was." />
...
<MdxLayout layout="2:10" className="stack__item--6">
  <Image imgs={props.images} name="autonomy" />
...
<MdxLayout layout="2:10" className="stack__item--6">
  <Image imgs={props.images} name="independence" />
...
<MdxLayout layout="2:10" className="stack__item--6">
  <Image imgs={props.images} name="focus" />
...
<Gallery caption="Grouping UI elements together by functionality allowed me to see where we had duplicated UI code.">
  <Image imgs={props.images} name="component-audit-1" />
  <Image imgs={props.images} name="component-audit-2" />
  <Image imgs={props.images} name="component-audit-3" />
  <Image imgs={props.images} name="component-audit-4" />
</Gallery>
...
Ensure that all the work done above is properly documented for our team, and the world.
  ...
  <Image imgs={props.images} name="task-list" caption="List of tasks detailing what must be completed to bring the design system online." />
</MdxLayout>
...
<Image imgs={props.images} name="macbook-demo" />
