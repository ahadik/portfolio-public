...
<MdxLayout layout="6:6:6:6" showBorderTop showBorderBottom>
<div style={{ marginTop: '0.5rem', marginBottom: '0.5rem'}}>

  ###### <i className="fa fa-check"></i> Determine Success
...
<div style={{ marginTop: '0.5rem', marginBottom: '0.5rem'}}>
  ...
  ###### <i className="fa fa-search"></i> Explore Data
