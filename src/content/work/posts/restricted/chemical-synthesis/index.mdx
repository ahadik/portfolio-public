...
<Button animateRight iconLeft="fal fa-book" iconRight="fal fa-long-arrow-right" hasBorder to="/work/restricted/chemical-synthesis/design-sprint">Read the Design Sprint Overview</Button>
