...
<Button animateRight iconRight="fal fa-long-arrow-right" to="/writing/data-supplier-2" hasBorder>Part 3: Providing Text Data and Refining User Experience</Button>
