...
<div style={{ display: 'flex', flexDirection: 'column', marginTop: '0.5rem' }} className="stack__children--4">
...
<Image imgs={props.images} name="collaboration" caption="A critique session with Katherine, a design intern." />
</MdxLayout>
